...
// Stock Integer Fields Customizing

const phsyical_number = document.querySelector('.phsyical_number')
const reserved_number = document.querySelector('.reserved_number')
const active_number = document.querySelector('.active_number')

active_number.value = phsyical_number.value - reserved_number.value
